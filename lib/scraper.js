...
async function scrapeList(page, keywords, { onProgress, resumeState, isStopped, isPaused, maxPages, onNewCreators, sellerId, fast }) {
...
async function scrapeByInput(page, inputs, { onProgress, isStopped, isPaused, onNewCreators, fast }) {
